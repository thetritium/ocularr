...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // FIXED: Pass rememberMe as third parameter
  ...
  const handleInputChange = (e) => {
    ...
    setFormData(prev => ({
      ...prev,
      [name]: type === 'checkbox' ? checked : value  // FIXED: Handle checkbox properly
    }));
  };
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  name="rememberMe"  // FIXED: Added name attribute
                  checked={formData.rememberMe}  // FIXED: Connected to state
