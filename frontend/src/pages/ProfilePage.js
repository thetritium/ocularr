...
const ProfilePage = () => {
  ...
  const fetchProfile = async () => {
    try {
      ...
      // Fetch profile by username using proper userAPI method
  ...
  const getProfilePictureUrl = () => {
    ...
    if (profile?.profile_picture) {
      ...
      return `${baseUrl}${profile.profile_picture}`;
    }
    return null;
  };
          ...
          <div className="bg-gray-800 rounded-lg p-6">
            <div className="text-center mb-6">
              ...
              <div className="relative inline-block mb-4">
                ...
                <div 
                  className={`w-32 h-32 bg-gray-700 rounded-full mx-auto flex items-center justify-center ${
                    getProfilePictureUrl() ? 'hidden' : 'flex'
                  }`}
                >
