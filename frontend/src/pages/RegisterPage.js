        ...
        <div className="bg-gray-800 rounded-lg shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className={`w-full bg-gray-900 border ${errors.username ? 'border-red-500' : 'border-gray-700'} px-3 py-2 rounded-lg focus:border-blue-500 focus:outline-none text-white`}
            ...
            <div>
              ...
              <input
                ...
                className={`w-full bg-gray-900 border ${errors.email ? 'border-red-500' : 'border-gray-700'} px-3 py-2 rounded-lg focus:border-blue-500 focus:outline-none text-white`}
                autoComplete="email"
              />
              {errors.email && (
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full bg-gray-900 border ${errors.password ? 'border-red-500' : 'border-gray-700'} px-3 py-2 pr-10 rounded-lg focus:border-blue-500 focus:outline-none text-white`}
            ...
            <div>
              ...
              <input
                ...
                className={`w-full bg-gray-900 border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-700'} px-3 py-2 rounded-lg focus:border-blue-500 focus:outline-none text-white`}
                autoComplete="new-password"
              />
            ...
            {/* REMOVED: Terms and Privacy Policy checkbox - No longer required */}
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <Link
                to="/login"
                className="w-full bg-gray-700 hover:bg-gray-600 text-center block py-3 px-4 rounded-lg font-medium transition-colors"
              >
                Sign In
              </Link>
            </div>
