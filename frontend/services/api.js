...
// FIXED: Use relative path for API calls - nginx will proxy to backend
// This allows the frontend to work with nginx proxy instead of direct backend connection
